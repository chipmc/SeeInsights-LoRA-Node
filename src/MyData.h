...
System Data
    ...
    10              uint8_t        nodeNumber           Assigned by the gateway on joining the network
	...
	30              time_t         lastConnection       last time we successfully connected to the gateway
    34              time_t         nextConnection       next time we will attempt to connect to the gateway
    ...
    50              uint8_t        placement            0 for outside, 1 for inside - determnines whether we count up or down
    31-49           Reserved
Current Data
