...
#define OCCUPANCY_ZONE_SPAD_DEPTH       6       // This is the depth (Through the door - when sensor mounted on the inside doorframe)
#define OCCUPANCY_FRONT_ZONE_CENTER     159     // Denotes the SPAD number (see chart above) that is the to the right and above the exact center of occupancy zone 1's ROI
#define OCCUPANCY_BACK_ZONE_CENTER      239     // Denotes the SPAD number (see chart above) that is the to the right and above the exact center of occupancy zone 2's ROI
