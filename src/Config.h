...
#define FLOOR_INTERFERENCE_BUFFER 250           // Flat value (in mm) to add to the measured distance in order to rule out variations that occur in measurements taken of the floor.
...
#define OCCUPANCY_ZONE_SPAD_WIDTH       16      // This is the width (accross the door with the sensor long axis perpendicular to the threshold) of the active SPADS
#define OCCUPANCY_ZONE_SPAD_DEPTH       8       // This is the depth (Through the door - when sensor mounted on the inside doorframe) 
#define OCCUPANCY_FRONT_ZONE_CENTER     167     // Denotes the SPAD number (see chart above) that is the to the right and above the exact center of occupancy zone 1's ROI
#define OCCUPANCY_BACK_ZONE_CENTER      231     // Denotes the SPAD number (see chart above) that is the to the right and above the exact center of occupancy zone 2's ROI
